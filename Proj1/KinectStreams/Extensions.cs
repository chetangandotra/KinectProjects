...
namespace KinectStreams
{
    public static class Extensions
    {
        ...
        public static void DrawSkeleton(this Canvas canvas, Body body)
        {
            ...
            canvas.DrawLine(body.Joints[JointType.SpineMid], body.Joints[JointType.SpineBase], true);
        ...
        public static void DrawLine(this Canvas canvas, Joint first, Joint second, bool writeToFile1 = false)
        {
        ...
        private static void writeToFile(Line line)
        {
            // Compose a string that consists of three lines.
            string lines = line.X1 + "," + line.Y1 + "," + DateTime.Now.ToString("HH:mm:ss tt");// +"," + "\r\n";
        ...
        private static void writeToFile(Joint line)
        {
            // Compose a string that consists of three lines.
            string lines = line.Position.X +"," + line.Position.Y + "," + line.Position.Z +  "," + DateTime.Now.ToString("HH:mm:ss tt");// +"," + "\r\n";
            string path = "C:\\Users\\Chetan\\Documents\\Kinect\\KinectStreams\\test.csv";
